...
* Spaces and special characters are not allowed in the username.`);
            return false;
        }
        if (!isValid(email.trim().toLowerCase(), 2)) {
    ...
    return (
        ...
        <View style={styles.container}>
            <View style={styles.stepContainer}>
                ...
                <Text style={styles.templet}>Username: </Text>
                ...
                <Text style={styles.haveAcc}>Already have account? <Link href='/login' style={{ color: "#ff4500" }}>Login</Link></Text>
            </View>
        </View>
    )
}
