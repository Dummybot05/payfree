...
const paycid = () => {
  ...
  return (
    ...
    <View style={styles.stepContainer}>
        ...
        <TextInput style={styles.input} placeholder="Customer ID" onChangeText={onChangePayCid} />
        <Text style={styles.templet}>Amount: </Text>
        <TextInput style={styles.input} placeholder="Enter Amount" onChangeText={onChangePayCid} />
